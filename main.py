...
for to_be_searched_number in range(90000000,90000010):
    ...
    #    if country.text == 'Oman':
    #        wait.until(EC.visibility_of(country)).click()
    #        break
    ...
    try:
        ...
        records = driver.find_elements(By.XPATH,"//div[@class='q-table__control']//span[@class='q-table__bottom-item']")
        print(records[-1].text)
        dropdown_pg = driver.find_elements(By.XPATH, "//i[contains(@class, 'q-icon') and contains(@class, 'notranslate') and contains(@class, 'material-icons') and contains(@class, 'q-select__dropdown-icon')]")
